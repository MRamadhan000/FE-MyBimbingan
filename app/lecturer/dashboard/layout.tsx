...
import { getLecturerProfile, logout } from '../../services/auth';
          ...
          <div className="relative">
            ...
            >
              <div className="text-right hidden md:block">
                ...
                <p className="text-[10px] text-blue-500 font-bold mt-1 uppercase tracking-tighter">{profile?.role || 'lecturer'}</p>
              </div>
