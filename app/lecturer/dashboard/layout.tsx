...
const MENU_ITEMS = [
  { label: 'Dashboard', pintasan: 'Dashboard Dosen', href: '/lecturer/dashboard', icon: <FiGrid size={20} /> },
  { label: 'Pengajuan Baru', pintasan: 'Kelola Pengajuan', href: '/lecturer/dashboard/pengajuan', icon: <FiFileText size={20} /> },
  { label: 'Daftar Mahasiswa', pintasan: 'Mahasiswa Bimbingan', href: '/lecturer/dashboard/bimbingan', icon: <FiUser size={20} /> },
  { label: 'Agenda Bimbingan', pintasan: 'Jadwal Bimbingan', href: '/lecturer/dashboard/agenda', icon: <FiCalendar size={20} /> },
  { label: 'Riwayat Bimbingan', pintasan: 'Riwayat Sesi', href: '/lecturer/dashboard/riwayat', icon: <FiClock size={20} /> },
  // { label: 'Pengaturan', pintasan: 'Konfigurasi Sistem', href: '/lecturer/dashboard/settings', icon: <FiSettings size={20} /> },
];
          ...
          <div className="relative">
            ...
            >
              <div className="text-right hidden md:block">
                <p className="text-xs font-black text-slate-800 leading-none">Dr. Ahmad Syarif</p>
                <p className="text-[10px] text-blue-500 font-bold mt-1 uppercase tracking-tighter">Dosen Pembimbing</p>
              </div>
            ...
            {isProfileOpen && (
              <div className="absolute right-0 mt-4 w-56 bg-white rounded-[2rem] shadow-2xl shadow-slate-200/50 border border-slate-100 py-3 z-50 overflow-hidden animate-in fade-in zoom-in duration-200">
                <div className="px-6 py-3 border-b border-slate-50 mb-2">
                  <p className="text-[10px] text-slate-400 uppercase font-black tracking-widest">Akun Dosen</p>
                </div>
